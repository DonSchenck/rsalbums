...
oc cp populate_table_rsalbums_BASH.sql $PODNAME:/tmp/populate_table_rsalbums_BASH.sql
oc cp populate_table_rsalbums_BASH.sh $PODNAME:/tmp/populate_table_rsalbums_BASH.sh
...
oc exec $PODNAME -- /bin/bash /tmp/populate_table_rsalbums_BASH.sh

echo "Populating tables..."
oc cp populate_table_rsalbumstracks_BASH.sql $PODNAME:/tmp/populate_table_rsalbumstracks_BASH.sql
oc cp populate_table_rsalbumstracks_BASH.sh $PODNAME:/tmp/populate_table_rsalbumstracks_BASH.sh
oc exec $PODNAME -- /bin/bash /tmp/populate_table_rsalbumstracks_BASH.sh
